...
import (
	...
	"buf.build/gen/go/coobeet/coobeet/connectrpc/go/coobeet/eliza/v1/elizav1connect"
	elizav1 "buf.build/gen/go/coobeet/coobeet/protocolbuffers/go/coobeet/eliza/v1"
	...
	"github.com/coobeet/coobeet/internal/eliza"
)
...
func main() {
	...
	mux.Handle(
		"/",
		http.RedirectHandler("https://coobeet.me/", http.StatusFound),
	)
